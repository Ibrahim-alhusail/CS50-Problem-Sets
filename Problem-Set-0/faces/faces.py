...
to prompt the user explicitly, as by passing a str of your own as an argument to input. Be sure to call main at the bottom of your file.
'''

def main():
    arg = str(input("Enter any input you want:\n> ")).strip()
    print(arg)
    convert(arg)
